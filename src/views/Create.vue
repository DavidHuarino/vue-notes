    ...
    <div class="w-full min-h-screen p-3" :class="bgColorContainer">
        <div class="space-y-3">
            ...
            <div v-if="editor" class="bg-gray-300 p-1 flex justify-around shadow-md border border-black" id="div-second">
                ...
                <button @click="editor.chain().focus().toggleItalic().run()" :class="{ 'is-active': editor.isActive('italic') }" class="p-2">
                    <svg viewBox="0 0 24 24" id="ri-italic" class="w-5 rounded">
                        <g>
                            <path fill="none" d="M0 0h24v24H0z"></path>
                ...
                <button @click="editor.chain().focus().toggleStrike().run()" :class="{ 'is-active': editor.isActive('strike') }" class="p-2">
                    <svg viewBox="0 0 24 24" id="ri-strikethrough" class="w-5 rounded bg-gray-300">
                        <g>
                            <path fill="none" d="M0 0h24v24H0z"></path>
                ...
                <button @click="editor.chain().focus().toggleHighlight().run()" :class="{ 'is-active': editor.isActive('highlight') }" class="p-2">
                    <svg viewBox="0 0 24 24" id="ri-mark-pen-line" class="w-5 rounded text-white">
                        <g>
                            <path fill="none" d="M0 0h24v24H0z"></path>
            ...
            <form id="my-form" @submit.prevent="createNote()" class="">
                <input id="div-last" v-model="title" type="text" class="w-full text-xl focus:outline-none py-3" :class="bgColorContainer" placeholder="Titulo">
                <!--
            ...
            <div class="inset-x-1 bottom-1 fixed bg-white rounded p-3 flex justify-evenly" id="div-third">
